...
describe("Cypress Locators", () => {
    ...
    it("Practice locating Web Elements using - get and contains", () => {
        ...
        cy.get('.card').eq(8); // index-based, starts from 0
        ...
        // This will do the same thing as above locator in amore explicit way
        // It will look for c ard with "HTML Elements" text only inside the class name
    ...
    it('Practice Web Elements - using find()', () => {
        ...
        // When we do this way, we try to lovate the web element with "Paragraph" text inside the div container 
